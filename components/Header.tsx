...
function Header() {
  ...
  return (
    <header className='z-[99] relative pb-28 sm:pb-36'>
      <motion.div
      ...
      <nav className='fixed flex top-[0.15rem] left-1/2  -translate-x-1/2 py-2 sm:top-[1.7rem] sm:h-[initial] sm:py-0'>
        <ul className='flex  w-[22rem] flex-wrap items-center justify-center gap-y-1 text-[0.9rem] font-medium text-gray-500 sm:w-[initial] sm:flex-nowrap sm:gap-5'>
          {links.map((link) => (
            ...
            >
              <Link
                className={`flex w-full justify-center items-center px-3 py-3 hover:text-gray-950 transition dark:text-gray-200 dark:hover:text-gray-200 ${
